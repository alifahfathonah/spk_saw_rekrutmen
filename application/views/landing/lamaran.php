    ...
    <section class="bg-light py-10">
        <div class="container">
            <div class="text-center mb-5" data-aos="fade-left">
                <h1 style="font-size: 40px">Daftar Lamaran Saya</h1>
            </div>


            <?php
            foreach ($list_lamaran as $row) : ?>


                <?php $rek = $this->Rekrutmen_m->get_row(['kd_rekrutmen' => $row->kd_rekrutmen]) ?>
                <a class="card post-preview post-preview-featured lift mb-5" href="<?= base_url('lamaran?kode=' . $row->kd_rekrutmen.'&id_calonguru=' . $row->id_calonguru ) ?>" data-aos="fade-right">
                    <div class="row no-gutters">
                        ...
                        <div class="col-lg-9">
                            <div class="card-body">
                                ...
                                <div class="py-2">
                                    <h5 class="card-title"><?= $rek->judul ?></h5>
                                    <p class="card-text">Keterangan : <br> <?= $rek->keterangan ?> </p>
                                    <b><?= date('d/m/Y', strtotime($rek->buka)) ?> - <?= date('d/m/Y', strtotime($rek->tutup)) ?></b>
                    ...
                    <div class="col-lg-10 col-xl-8">
                        <div class="single-post">
                           ...
                           <?php
                               ...
                               $a = $this->Laporan_m->get_row(['kd_rekrutmen'=> $_GET['kode'], 'id_calonguru' => $_GET['id_calonguru']]);
                                if ($a->status == 1) { ?>
                                  
                            <div class="single-post-text my-5 text-green"> <h2 class="text-red"><center>Selamat anda berhasil diterima dan akan segera di hubungi pihak kami.</center></h2>
                            </div>
                                <?php    }else { ?>
                                     <div class="single-post-text my-5 ">
                                <h2 class="text-red"><center>Maaf, anda belum diterima. Terima kasih telah berpartisipasi.</center></h2>
                            </div>
                             <?php  } ?>
                            </div>
                    </div>
