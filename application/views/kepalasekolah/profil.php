    ...
    <div class="row">
      ...
      <div class="col-xl-8">
        ...
        <div class="card mb-4">
          ...
          <div class="card-body">
            <?php echo form_open_multipart('operator/proses_edit_profil'); ?>
            ...
            <div class="mb-3">
              ...
              <input type="text" id="inputnama_lengkap" name="nama_lengkap" class="form-control" placeholder="Nama Lengkap" value="<?= $profil->nama_lengkap ?>" />
            </div>

            <div class="mb-3">
              <label class="small mb-1" for="inputjk">Jenis Kelamin</label>
              <div class="col-sm-10">
                <input name="jk" type="radio" id="jk1" <?php if ($profil->jk == "Laki - Laki") {
                                                          echo "checked";
                                                        } ?> value="Laki - Laki" required />
                <label for="jk1">Laki - Laki</label>
                <input name="jk" type="radio" id="jk2" <?php if ($profil->jk == "Perempuan") {
                                                          echo "checked";
            ...
            <div class="row gx-3 mb-3">
              ...
              <div class="col-md-6">
                ...
                <input class="form-control" id="inputBirthday" type="date" name="tanggal_lahir" placeholder="Enter your birthday" value="<?= $profil->tanggal_lahir ?>" />
              </div>

              <div class="col-md-6">
                <label class="small mb-1" for="inputPhone">Nomor Telepon</label>
                <input class="form-control" id="inputPhone" type="text" name="no_telp" placeholder="Enter your phone number" value="<?= $profil->no_telp ?>" />
              </div>
              <!-- Form Group (birthday)-->
      ...
      <div class="col-xl-4">
        ...
        <div class="card mb-4 mb-xl-3">
          ...
          <div class="card-body text-center">
            ...
            <?php if ($profil->foto != 'foto/default.jpg') { ?>
              <img class="profile-user-img img-fluid img-circle" src="<?= base_url() ?>/assets/<?= $profil->foto ?>" alt="User profile picture" style="width: 180px; height: 180px">
              <?php } else {
              if ($profil->jk == "Laki - Laki") {
              ?>
  ...
  <div class="modal-dialog modal-md" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <?= form_open_multipart('operator/proses_edit_profil/') ?>
...
<div class="modal fade" id="ganti" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-md" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?= base_url('operator/proses_edit_profil') ?>" method="Post" id="editform2">
