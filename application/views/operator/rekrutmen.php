...
<div class="container-xl px-4 mt-n10">
    <div class="card mb-4">
        <div class="card-body">
            ...
            <button type="button" data-bs-toggle="modal" data-bs-target="#tambah" class="btn btn-primary">Buat Rekrutmen Baru</button>
                    ...
                    foreach ($list_rekrutmen as $row) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?= base_url('operator/rekrutmen/' . $row->kd_rekrutmen) ?>">
